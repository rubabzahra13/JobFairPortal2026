  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const submission = {
        ...
        suggestedArchetype: result.suggestions?.archetype,
        suggestedScores: result.suggestions?.scores,
        suggestedScoreReasons: result.suggestions?.scoreReasons,
        evaluationSuggestionNote: result.suggestions?.note,
        personalitySummary: result.suggestions?.personalitySummary,
